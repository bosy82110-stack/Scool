...
const styles = StyleSheet.create({ background: { flex: 1, backgroundColor: "#17324D" }, brand: { alignSelf: "flex-end", flexDirection: "row-reverse", alignItems: "center", gap: 10, backgroundColor: "rgba(255,255,255,0.9)", borderRadius: 18, paddingVertical: 8, paddingHorizontal: 12 }, brandMark: { width: 30, height: 30, borderRadius: 10, backgroundColor: "#FFD166", color: "#18324B", fontSize: 18, fontWeight: "900", textAlign: "center", textAlignVertical: "center" }, brandName: { color: "#18324B", fontSize: 17, fontWeight: "900" }, bottomCard: { backgroundColor: "rgba(255,255,255,0.94)", borderRadius: 28, padding: 22, marginBottom: 12 }, kicker: { textAlign: "right", color: "#4F9CF9", fontWeight: "800", fontSize: 14 }, title: { textAlign: "right", color: "#18324B", fontWeight: "900", fontSize: 30, marginTop: 5 }, subtitle: { textAlign: "right", color: "#6D7C8C", fontSize: 16, marginTop: 5, marginBottom: 18 }, button: { minHeight: 56, borderRadius: 18, backgroundColor: "#4F9CF9", alignItems: "center", justifyContent: "center" }, buttonText: { color: "#FFFFFF", fontSize: 18, fontWeight: "900" }, note: { color: "#6D7C8C", textAlign: "center", fontSize: 11, marginTop: 12 }, pressed: { opacity: 0.8, transform: [{ scale: 0.98 }] } });
